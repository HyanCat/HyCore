...
#define IOS6_OR_BEFORE HY_SYSTEM_VERSION_LESS_THAN_OR_EQUAL_TO(@"6")
#define IOS7_OR_BEFORE HY_SYSTEM_VERSION_LESS_THAN_OR_EQUAL_TO(@"7")
#define IOS8_OR_BEFORE HY_SYSTEM_VERSION_LESS_THAN_OR_EQUAL_TO(@"8")
#define IOS9_OR_BEFORE HY_SYSTEM_VERSION_LESS_THAN_OR_EQUAL_TO(@"9")
